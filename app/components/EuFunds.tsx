      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <span className="block text-blue-500 font-semibold text-sm uppercase tracking-widest mb-3">
              EU financiranje
            </span>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-12">
            {[
              ...
              >
                <div className="text-5xl font-bold text-blue-500/20 absolute top-4 right-4 select-none">
                  {item.step}
                </div>
          ...
          {/* CTA banner */}
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
            ...
            <a
              href="#kontakt"
              className="flex-shrink-0 bg-white text-blue-600 font-bold px-7 py-4 rounded-full hover:bg-blue-50 transition-colors shadow-lg whitespace-nowrap"
            >
              Prijavite se →
            </a>
          </div>
